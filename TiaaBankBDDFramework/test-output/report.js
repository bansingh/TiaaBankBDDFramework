$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/vanda/eclipse-workspace/TiaaBankBDDFramework/src/main/java/Features/submitApplication.feature");
formatter.feature({
  "line": 1,
  "name": "TIAA Submit Application feature",
  "description": "",
  "id": "tiaa-submit-application-feature",
  "keyword": "Feature"
});
formatter.scenario({
  "line": 3,
  "name": "TIAA Submit Application Scenario",
  "description": "",
  "id": "tiaa-submit-application-feature;tiaa-submit-application-scenario",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.step({
  "line": 6,
  "name": "title of Home page is TIAA Bank :: Bank on Better: High Yields, Home Loans, 24/7 Support",
  "keyword": "When "
});
formatter.step({
  "line": 7,
  "name": "user clicks on Open an account button",
  "keyword": "Then "
});
formatter.step({
  "line": 8,
...
formatter.step({
  "line": 9,
  "name": "user click on Start Application button",
  "keyword": "Then "
});
formatter.step({
  "line": 10,
  "name": "user is redirected to Online Application page",
  "keyword": "Then "
});
formatter.step({
  "line": 11,
...
formatter.step({
  "line": 12,
  "name": "user enters opening deposit amount",
  "rows": [
    {
      "cells": [
        "OpeningDeposit"
...
formatter.step({
  "line": 16,
  "name": "user enters Applicant details",
  "keyword": "Then "
});
formatter.step({
  "line": 17,
  "name": "user clicks on ApplicantDetailsContinue button",
  "keyword": "Then "
});
formatter.step({
  "line": 18,
  "name": "user clicks on ReviewInfoContinue button",
  "keyword": "Then "
});
formatter.step({
  "line": 19,
  "name": "user Esigns and accepts the disclosures",
  "keyword": "Then "
});
formatter.step({
  "line": 20,
  "name": "user clicks on Submit Application button",
  "keyword": "Then "
});
formatter.match({
